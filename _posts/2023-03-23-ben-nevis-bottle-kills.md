...
{% include review.html id="ben-nevis-8-sv" %}
...
<img src="https://files.emilmallmin.com/wb_SV_BN_review.png"
     class="align-center"
     style="width:80%;">
...
{% include review.html id="ben-nevis-5-ad" %}

Again, I realized I wrote a review last year, which makes for fun comparison:

<img src="https://files.emilmallmin.com/wb_adelphi_BN_review.png"
     class="align-center"
     style="width:80%;">
