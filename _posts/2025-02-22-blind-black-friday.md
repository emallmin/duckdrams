...
- **Comments before reveal**: The process of exclusion leads me to say this is the Brora: no detectable peat, ruling out the Islays, and not funky enough to be Springbank. It’s really nice and clearly an old whisky, but not like my first Broras.
- **Comments after reveal**: (note: only after I made my review/guess for each sample)
Ok, Springbank was the second guess, but still a little too clean for that, given how many other dirty ones there are in the line up. One can surely tell there’s old bottle effect with this one, but for me it made for an interesting experience blindly.
- **Score**: Deliciousness ⚫🟡🟢
Fun factor ⚫⚫🟢
Value for money 🔴🟡⚫
...
- **Comments before reveal**: At first I was really uncertain, but now with a lot of time in the glass I’m getting a cheesy Springbank vibe, and the tasting notes are pointing there too.
- **Comments after reveal**: So I got the Brora and the Springbank swapped… At first I thought this might be Brora indeed, but I really couldn’t get #1 to be SB so I ended up convincing myself this was more likely the SB. Really good one, although not a contender to the 34 and 35yo ones I had earlier, obviously.
- **Score**: 
Deliciousness ⚫⚫🟢
Fun factor ⚫⚫🟢
Value for money 🔴⚫⚫
...
- **Comments before reveal**: Easy to pick out as Macallan in this lineup. It’s really good, but to me doesn’t reach the complexity of a really old cognac, which I suspect is still a lot cheaper.
- **Comments after reveal**: Yep, it’s a really strong Macallan. There are signs of youths, but also of maturity beyond what you’d expect to find in a 12yo sherried whisky these days. I’m betting this has to do with this being a real sherry cask, not a seasoned one, and to a smaller extent old bottle effect.
- **Score**: Deliciousness ⚫🟡🟢
Fun factor ⚫🟡🟢
Value for money 🔴⚫⚫
...
- **Comments before reveal**: Hmmm from the nose I was really expecting Springbank. But on the palate the peat is so intense that this has to be Laphroaig, which I indeed have also found very “farmy” in the past. Or have they picked out a Longrow? Nah, I’ll stick with Laphi.
- **Comments after reveal**: Well, I don’t really know Port Ellen very well, so it’s not tough to be wrong here (and #6 which turns out to be Laphi was rather untypical). Imagine a 14yo being bottled nowadays and sold sub-€100, that’d be neat.
- **Score**: Deliciousness ⚫⚫🟢
Fun factor ⚫⚫🟢
Value for money 🔴⚫⚫
Punchline - My kind of dung
...
- **Comments before reveal**: Something about the nose is very subtly different from any other whisky I ever had… The decision here is between Springbank and Bowmore, but I feel a lot more like it’s the latter. If I were to choose one of these dram’s to get a bottle of, it would be this one.
- **Comments after reveal**: Yes, indeed!
- **Score**: Deliciousness ⚫⚫🟢
Fun factor ⚫⚫🟢
Value for money 🔴⚫⚫
...
- **Comments before reveal**: Quite hard, because there’s basically sulphury sherry and peat to go on and not much else. So I’ll venture to guess Port Ellen, which just so happens to final name to place.
- **Comments after reveal**: Huh, it’s a bottling of Laphi that people seem to really wax lyrical about. I can get on board with the BBQ, bacon, soy sauce, Worcestershire sauce, etc, that I didn’t write down. There’s a lot of flavour, and maybe my palate was a rather fatigued by the final dram, but I just didn’t find it exceptionally good.
- **Score**: Deliciousness ⚫🟡⚫
Fun factor ⚫🟡🟢
Value for money 🔴⚫⚫
Punchline - Sulphroaig


So I ended up swapping the Brora and the Springbank, and the Port Ellen and the Laphroaig. At least the Macallan and Bowmore I had little doubt about. Let’s see if Black Friday 2025 can match this beast of a tasting, and give me a chance at redemption.