...
- **Comments before reveal**: Today I’ll be a straight shooter: I think this is Tullibardine, 14yo, 57%, and finished in PX cask. I have no memory that my stash actually contains just such a dram, though.
- **Comments after reveal**: Actually, Glen Garioch makes sense! Just before I had the regular 12yo, and there is congruency. A floral note is typical of both Tulli and GG (more lavender in the former, heather in the latter) so it’s not a bad guess.
- **Score**: Deliciousness ⚫⚫🟢
Fun factor ⚫🟡🟢
Value for money ⚫🟡⚫
...
- **Comments**: I got this sample when I bought the full bottle from Simple Sample. I adore the nose; sipping it is definitely good and in my style but not spectacular. I imagine the bottle exposes to some oxidation will get better.
- **Score**: Deliciousness ⚫🟡🟢
Fun factor ⚫🟡⚫
Value for money ⚫🟡⚫
Punchline - Solid contemporary Clynelish