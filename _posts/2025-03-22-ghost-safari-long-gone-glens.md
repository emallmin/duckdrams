---
layout: single
title: "Ghost Safari — Long-gone glens"
date: 2025-03-22
categories: Legacy
tags: ported
header:
  overlay_image: https://files.emilmallmin.com/glenury.jpg
  overlay_filter: 0.5
  teaser: https://files.emilmallmin.com/glenury.jpg
---

*This post has be ported from the old blog. Full formatting and inclusion in the review index to be done. [Link to the original post](https://duckdrams.com/2025/03/22/ghost-safari-long-gone-glens/)*
...
## Glen Flagler | “70 Proof” | 1970s | 40% | Official | [WB173765](https://www.whiskybase.com/whiskies/whisky/173765)
- **Info**: Bottle availablity: €500 secondary market. Review: from a 5cl sample bottle
- **Nosing**: A light, fruity, and elegant nose. Clementine, banana, pear, fresh cream, lightly grassy,
- **Sipping**: Juicy, with apples, pears and oranges, a hint of oak spice, and a malty background. A little thin from the low abv.
- **Comments**: “In the great Scottish tradition of yesteryear Glen Flagler is all-malt, 100% pot still whisky. a rare and distinctive reminder in this century of a gentler era.” I really like this delicate fruity style that some might find it boring. In any case, I think Glen Flagler is known for being rare, not for being exceptionally good.
- **Score**: Deliciousness ⚫🟡🟢
Fun factor ⚫🟡⚫
Value for money (not considered) ⚫⚫⚫  Punchline - Reminder of a gentler era


## Glen Albyn | “Culloden” | 15yo (1996) | 43% | Royal Mile Whiskies | [WB116954](https://www.whiskybase.com/whiskies/whisky/116954)
- **Info**: Bottle availablity: very rare. Review: from a 5cl sample bottle
- **Nosing**: It is a little sharp and solventy; looking past this there’s a malty, earthy, and fruity profile. Indistinct yellow fruits, gentle woody aromas, marzipan, baked sweet buns.
- **Sipping**: Peppery, and very malty, somewhat oily. Definitely pears and melon, some cookies, but I am mostly finding the spice and spirity qualities.
- **Comments**: I’d easily have thought this one to be of a much higher ABV because of the spiciness. Didn’t hit home with me, really.
- **Score**: Deliciousness ⚫🟡⚫
Fun factor ⚫🟡⚫
...
- **Comments**: It’s really quite austere — no indulgent confectionary notes here — but exploring among the subtle fruit, herbs, and flowers makes this really interesting, albeit not immediately charming.
- **Score**: Deliciousness ⚫🟡⚫
Fun factor ⚫⚫🟢
...
- **Sipping**: Sweet, and just a little savoury and salty, and just the perfect small amount of wood tannins. Red berries & fruits, leather, pumpkin, confection, more almonds, a little rubber and smoke; autumnal. Not unlike a 40yo+ Armagnac.

- **Comments**: Lots of cask influence here, but not a completely swamped spirit. It manages to stay quite balanced; just a little bit of tannins and rubber/sulphur to pique the interest.

- **Score**: Deliciousness ⚫🟡🟢
Fun factor ⚫🟡🟢
Value for money (not considered) ⚫⚫⚫
Punchline - I’d like to have this again sometime in October
